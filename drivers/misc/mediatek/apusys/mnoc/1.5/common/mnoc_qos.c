...
static void qos_timer_func(struct timer_list *timer_list)
{
...
void apu_qos_counter_init(struct device *dev)
{
	...
	// TODOpm_qos_add_request(&apu_qos_ddr_req, PM_QOS_DDR_OPP,
		//PM_QOS_DDR_OPP_DEFAULT_VALUE);
	pm_qos_add_request(&apu_qos_cpu_dma_req, PM_QOS_CPU_DMA_LATENCY,
		PM_QOS_CPU_DMA_LAT_DEFAULT_VALUE);
	//TODO apu_qos_boost_ddr_opp = PM_QOS_DDR_OPP_DEFAULT_VALUE;
#endif
...
#if MNOC_QOS_BOOST_ENABLE
//TODO	pm_qos_update_request(&apu_qos_ddr_req,
//		PM_QOS_DDR_OPP_DEFAULT_VALUE);
//TODO	pm_qos_remove_request(&apu_qos_ddr_req);
	pm_qos_update_request(&apu_qos_cpu_dma_req,
		PM_QOS_CPU_DMA_LAT_DEFAULT_VALUE);
