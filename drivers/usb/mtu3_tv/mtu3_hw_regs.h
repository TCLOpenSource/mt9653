...
#define SSUSB_U2_PORT_OTG_PWRCTL_HSEL	BIT(10)
#endif
...
/* chiptop bnak for FPGA only */
#define SSUSB_CHIP_DUMMY_REG_2		0x78	/* reg_chiptop_dummy_2 */
#define SSUSB_I2C_MODE			BIT(0)	/* ssusb_i2c_mode */
#define SSUSB_U3FPGA_USB_EN		BIT(1)	/* u3fpag_usb_en */
#define SSUSB_SHBG_LINESTATE_HACK	BIT(2)	/* rg_shbg_linestate_hack */
#endif
