...
#ifndef _DVB_VB2_V2_H
#define _DVB_VB2_V2_H
...
/**
 * enum dvb2_buf_type - types of Digital TV memory-mapped buffers
 *
 * @DVB2_BUF_TYPE_CAPTURE: buffer is filled by the Kernel,
 *			  with a received Digital TV stream
 */
enum dvb2_buf_type {
	DVB2_BUF_TYPE_CAPTURE = 1,
};

/**
 * enum dvb2_vb2_states - states to control VB2 state machine
 * @DVB2_VB2_STATE_NONE:
 *	VB2 engine not initialized yet, init failed or VB2 was released.
 * @DVB2_VB2_STATE_INIT:
 *	VB2 engine initialized.
 * @DVB2_VB2_STATE_REQBUFS:
 *	Buffers were requested
 * @DVB2_VB2_STATE_STREAMON:
 ...
 */
enum dvb2_vb2_states {
	DVB2_VB2_STATE_NONE	= 0x0,
	DVB2_VB2_STATE_INIT	= 0x1,
	DVB2_VB2_STATE_REQBUFS	= 0x2,
	DVB2_VB2_STATE_STREAMON	= 0x4,
};

#define DVB2_VB2_NAME_MAX (20)

/**
 * struct dvb2_buffer - video buffer information for dvb2.
 *
 * @vb:		embedded struct &vb2_buffer.
 * @list:	list of &struct dvb2_buffer.
 */
struct dvb2_buffer {
...
/**
 * struct dvb2_vb2_ctx - control struct for VB2 handler
 * @vb_q:	pointer to &struct vb2_queue with videobuf2 queue.
 * @_mutex: default mutex
...
struct dvb2_vb2_ctx {
	...
	enum dmx2_buffer_flags flags;
	u32	count;

	char name[DVB2_VB2_NAME_MAX + 1];
};

#ifndef CONFIG_DVB_MMAP

static inline int dvb2_vb2_init(
...
static inline int dvb2_vb2_release(struct dvb2_vb2_ctx *ctx)
{
	return 0;
}

#define dvb2_vb2_is_streaming(ctx) (0)
#define dvb2_vb2_fill_buffer(ctx, file, wait, flags) (0)

static inline __poll_t dvb2_vb2_poll(
	struct dvb2_vb2_ctx *ctx,
	struct file *file,
	poll_table *wait)
{
...
/**
 * dvb2_vb2_init - initializes VB2 handler
 *
 ...
 */
int dvb2_vb2_init(struct dvb2_vb2_ctx *ctx, const char *name, int non_blocking, int wo_memcpy);

/**
 * dvb2_vb2_release - Releases the VB2 handler allocated resources and
...
/**
 * dvb2_vb2_is_streaming - checks if the VB2 handler is streaming
 * @ctx:	control struct for VB2 handler
 *
...
/**
 * dvb2_vb2_fill_buffer - fills a VB2 buffer
 * @ctx:	control struct for VB2 handler
 ...
 *		can be NULL.
 */
int dvb2_vb2_fill_buffer(
	struct dvb2_vb2_ctx *ctx,
	const unsigned char *src, int len,
	enum dmx2_buffer_flags *buffer_flags);

/**
 * dvb2_vb2_poll - Wrapper to vb2_core_streamon() for Digital TV
 *      buffer handling.
 *
 * @ctx:	control struct for VB2 handler
...
/**
 * dvb2_vb2_stream_on() - Wrapper to vb2_core_streamon() for Digital TV
 *	buffer handling.
 *
 * @ctx:	control struct for VB2 handler
 *
...
/**
 * dvb2_vb2_stream_off() - Wrapper to vb2_core_streamoff() for Digital TV
 *	buffer handling.
 *
 * @ctx:	control struct for VB2 handler
 *
...
/**
 * dvb2_vb2_reqbufs() - Wrapper to vb2_core_reqbufs() for Digital TV
 *	buffer handling.
 *
 * @ctx:	control struct for VB2 handler
...
/**
 * dvb2_vb2_querybuf() - Wrapper to vb2_core_querybuf() for Digital TV
 *	buffer handling.
 *
 * @ctx:	control struct for VB2 handler
...
/**
 * dvb2_vb2_expbuf() - Wrapper to vb2_core_expbuf() for Digital TV
 *	buffer handling.
 *
 * @ctx:	control struct for VB2 handler
...
/**
 * dvb2_vb2_qbuf() - Wrapper to vb2_core_qbuf() for Digital TV buffer handling.
 *
 * @ctx:	control struct for VB2 handler
 * @b:		&struct dmx_buffer passed from userspace in
...
/**
 * dvb2_vb2_dqbuf() - Wrapper to vb2_core_dqbuf() for Digital TV
 *	buffer handling.
 *
 * @ctx:	control struct for VB2 handler
 * @b:		&struct dmx_buffer passed from userspace in
...
/**
 * dvb2_vb2_mmap() - Wrapper to vb2_mmap() for Digital TV buffer handling.
 *
 * @ctx:	control struct for VB2 handler
