...
/* ------------------------------------------ Enums --------------------------------------------- */
/* ============================================================================================== */
enum srccap_memout_svp_aid {
	SRCCAP_MEMOUT_SVP_AID_NS = 0,
	SRCCAP_MEMOUT_SVP_AID_SDC,
	SRCCAP_MEMOUT_SVP_AID_S,
	SRCCAP_MEMOUT_SVP_AID_CSP,
	SRCCAP_MEMOUT_SVP_AID_MAX,
};

enum srccap_memout_tee_action {
	SRCCAP_MEMOUT_TEE_ACT_CREATE_VIDEO_PIPELINE = 100,
	SRCCAP_MEMOUT_TEE_ACT_DESTROY_VIDEO_PIPELINE,
	SRCCAP_MEMOUT_TEE_ACT_CREATE_DISP_PIPELINE,
	SRCCAP_MEMOUT_TEE_ACT_DESTROY_DISP_PIPELINE,
	SRCCAP_MEMOUT_TEE_ACT_CREATE_COMP_PIPELINE,
	SRCCAP_MEMOUT_TEE_ACT_DESTROY_COMP_PIPELINE,
	SRCCAP_MEMOUT_TEE_ACT_WRITE_PROTECTED_REG,
	SRCCAP_MEMOUT_TEE_ACT_TEST_DRIVERS,

	SRCCAP_MEMOUT_TEE_ACTION_MAX,
};
...
struct srccap_memout_svp_info {
	...
	bool svp_enable;
	enum srccap_memout_svp_aid aid;
	u32 video_pipeline_ID;
};

#define SRCCAP_MEMOUT_OPTEE_HANDLER_VERSION (1) //Need to aligned with TEE driver header
struct srccap_memout_optee_handler {
	u16 version;
	u16 length;
	enum srccap_memout_svp_aid aid;
	u32 vdo_pipeline_ID;
