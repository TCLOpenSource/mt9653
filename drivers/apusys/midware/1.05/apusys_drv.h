...
#define APUSYS_IOCTL_MEM_CACHE_FLUSH \
	_IOWR(APUSYS_MAGICNO, 17, struct apusys_mem)
#define APUSYS_IOCTL_MEM_CACHE_INVALIDATE \
	_IOWR(APUSYS_MAGICNO, 18, struct apusys_mem)
