...
static void apupll_set_rate(unsigned long rate)
{
	...
	riu_write16(0x100c, 0x35, 0x01f4);
	riu_write16(0x100c, 0x33, 0x00a9);
	riu_write16(0x100c, 0x38, 0x0001);
	riu_write16(0x100c, 0x32, 0x0001);
	riu_write16(0x100c, 0x02, 0x0100);
	riu_write16(0x100c, 0x03, 0x0018);
	riu_write16(0x100c, 0x07, 0x0024);
	riu_write16(0x100c, 0x04, 0x0010);
	riu_write16(0x100c, 0x01, 0x0000);
	udelay(500);
	riu_write16(0x100c, 0x01, 0x0080);
}
