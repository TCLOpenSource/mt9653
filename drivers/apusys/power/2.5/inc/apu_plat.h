...
struct apu_plat_ops {
	...
	/* externel plug-in */
	int (*get_target_freq)(struct apu_dev *ad);
	int (*mtcmos_on)(struct apu_dev *ad, int force);
	void (*mtcmos_off)(struct apu_dev *ad, int force);
	int (*init_mtcmos)(struct apu_dev *ad);
	void (*uninit_mtcmos)(struct apu_dev *ad);
	void (*suspend)(struct apu_dev *ad);
	void (*resume)(struct apu_dev *ad);
	unsigned long (*power_status)(void);
	/* opp segment flags */
