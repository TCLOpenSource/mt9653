...
static int mdla_suspend(struct device *dev)
{
	struct apu_dev *ad = dev_get_drvdata(dev);

	if (ad->plat_ops->suspend)
		ad->plat_ops->suspend(ad);

	return 0;
}

static int mdla_resume(struct device *dev)
{
	struct apu_dev *ad = dev_get_drvdata(dev);

	if (ad->plat_ops->resume)
		ad->plat_ops->resume(ad);
...
static int mdla_devfreq_probe(struct platform_device *pdev)
{
	...
	ad->plat_ops = dtv_apupwr_get_ops(ad, apu_data->plat_ops_name);
	...
	/* must before init_devfreq to avoid Kasan issue*/
...
static const struct apu_plat_data mt5896_mdla_data = {
	.user = MDLA,
	.clkgp_name = "mt688x_mdla",
	.rgulgp_name = "mt688x_mdla",
	.plat_ops_name = "mt5896_platops",
};

static const struct apu_plat_data mt5896_mdla0_data = {
	.user = MDLA0,
	.bypass_target = 0,
	.clkgp_name = "mt688x_mdla0",
	.rgulgp_name = "mt688x_mdla0",
...
static const struct apu_plat_data mt5897_mdla_data = {
	.user = MDLA,
	.clkgp_name = "mt688x_mdla",
	.rgulgp_name = "mt688x_mdla",
	.plat_ops_name = "mt5897_platops",
};

static const struct apu_plat_data mt5897_mdla0_data = {
	.user = MDLA0,
	.bypass_target = 0,
	.clkgp_name = "mt688x_mdla0",
	.rgulgp_name = "mt688x_mdla0",
...
static const struct apu_plat_data mt5879_mdla_data = {
	.user = MDLA,
	.clkgp_name = "mt688x_mdla",
	.rgulgp_name = "mt688x_mdla",
	.plat_ops_name = "mt5879_platops",
};

static const struct apu_plat_data mt5879_mdla0_data = {
	.user = MDLA0,
	.bypass_target = 0,
	.clkgp_name = "mt688x_mdla0",
	.rgulgp_name = "mt688x_mdla0",
...
static const struct apu_plat_data mt5896_e3_mdla_data = {
	.user = MDLA,
	.clkgp_name = "mt688x_mdla",
	.rgulgp_name = "mt688x_mdla",
	.plat_ops_name = "mt5896_e3_platops",
};

static const struct apu_plat_data mt5896_e3_mdla0_data = {
	.user = MDLA0,
	.bypass_target = 0,
	.clkgp_name = "mt688x_mdla0",
	.rgulgp_name = "mt688x_mdla0",
...
static const struct of_device_id mdla_devfreq_of_match[] = {
	...
	{ .compatible = "mt5896,apumdla", .data = &mt5896_mdla_data },
	{ .compatible = "mt5896,apumdla0", .data = &mt5896_mdla0_data },
	{ .compatible = "mt5897,apumdla", .data = &mt5897_mdla_data },
	{ .compatible = "mt5897,apumdla0", .data = &mt5897_mdla0_data },
	{ .compatible = "mt5879,apumdla", .data = &mt5879_mdla_data },
	{ .compatible = "mt5879,apumdla0", .data = &mt5879_mdla0_data },
	{ .compatible = "mt5896_e3,apumdla", .data = &mt5896_e3_mdla_data },
	{ .compatible = "mt5896_e3,apumdla0", .data = &mt5896_e3_mdla0_data },
	{ },
};
