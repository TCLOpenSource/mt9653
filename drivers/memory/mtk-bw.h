...
#define CHECK_BOND_BASE		(0x201400)
#define CHECK_BOND_SIZE		(0x4)
#define CHK_BOND_CLK(val)	(((val) >> 2) & 0x1)
#define CHK_BOND_EXT_MCP(val)	(((val) >> 3) & 0x3)
#define CHK_BOND_EXT		(1)
#define CHK_BOND_MCP_AND_EXT	(2)
#define CHK_BOND_MCP		(3)
#define CHK_BOND_3200		(0)
#define CHK_BOND_2666		(1)
