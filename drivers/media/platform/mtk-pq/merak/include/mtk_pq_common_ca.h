...
#ifndef _MTK_PQ_COMMON_CA_H
#define _MTK_PQ_COMMON_CA_H
...
/* ------------------------------------------ Enums --------------------------------------------- */
/* ============================================================================================== */
enum mtk_pq_common_ca_smc_param_idx {
	PQ_CA_SMC_PARAM_IDX_0 = 0,
	PQ_CA_SMC_PARAM_IDX_1,
	PQ_CA_SMC_PARAM_IDX_2,
	PQ_CA_SMC_PARAM_IDX_3,
	PQ_CA_SMC_PARAM_IDX_MAX,
};
