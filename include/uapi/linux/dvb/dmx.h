...
struct dmx_requestbuffers {
	__u32 type;
	#define DMX_TYPE_CAPTURE		1
	#define DMX_TYPE_CAPTURE_MPLANE	2
	__u32 memory;
	#define DMX_MEMORY_MMAP			1
	#define DMX_MEMORY_USERPTR		2
	#define DMX_MEMORY_DMABUF		3
	__u32			count;
	__u32			size[DMX_MAX_PLANES];
};
