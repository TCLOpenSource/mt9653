...
#ifdef CONFIG_ARCH_MEDIATEK_DTV
enum dvb_vb2_plane_attrs {
	DVB_VB2_PLANE_ATTR_NONE		= 0x0,
	DVB_VB2_PLANE_ATTR_NONBLOCK	= 0x1,
	DVB_VB2_PLANE_ATTR_WO_COPY	= 0x2,
};
#endif
...
#ifdef CONFIG_ARCH_MEDIATEK_DTV
	int	offset[VB2_MAX_PLANES];
	int	remain[VB2_MAX_PLANES];
#else
	int offset;
	int remain;
#endif
